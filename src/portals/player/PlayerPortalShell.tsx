      ...
      <aside className={`athlete-sidebar ${mobileMenuOpen ? 'is-open' : ''}`} id="athlete-desktop-sidebar">
        ...
        <div className="athlete-sidebar-header">
          <img
            ...
            className="athlete-sidebar-logo"
            onError={(e) => {
              // Fallback if brand asset is unavailable
              (e.target as HTMLElement).style.display = 'none';
            }}
          />
          <div className="min-w-0">
            <h1 className="athlete-sidebar-brand-title">
              UNITED OLYMPICS SPORTS
            </h1>
            <span className="athlete-sidebar-brand-subtitle">
        ...
        <div className="athlete-mini-badge" id="athlete-mini-identity">
          <PlayerPortrait
            name={player.nameEn}
            className="athlete-mini-avatar"
          />
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-1.5">
              <span className="font-bold text-[13px] truncate text-slate-100">
                {player.nameEn}
              </span>
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    {item.badge !== undefined && (
                      <span className="athlete-nav-badge">
                        {item.badge}
                      </span>
                    )}
                  </NavLink>
        ...
        <header className="athlete-topbar" id="athlete-topbar">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            >
              ...
              <span><BilingualText value={bi('Switch Sport / Athlete', 'تبديل الرياضة / اللاعب')} /></span>
            </button>
                    ...
                    {notifications.map((notif) => (
                      <div
                        ...
                        className={`py-2.5 px-2 rounded-lg cursor-pointer transition-colors ${
                          notif.isRead ? 'opacity-70 hover:bg-white/5' : 'bg-amber-400/5 hover:bg-amber-400/10'
                        }`}
                      >
          ...
          <div className="athlete-drawer-sheet" id="athlete-more-drawer">
            ...
            <div className="grid grid-cols-2 gap-2.5">
              ...
              >
                ...
                <span className="text-xs font-medium"><BilingualText value={bi('Attendance', 'الحضور')} /></span>
              </Link>
              ...
              >
                ...
                <span className="text-xs font-medium"><BilingualText value={bi('Achievements', 'الإنجازات')} /></span>
              </Link>
              ...
              >
                ...
                <span className="text-xs font-medium"><BilingualText value={bi('Coach Notes', 'ملاحظات المدرب')} /></span>
              </Link>
              ...
              >
                ...
                <span className="text-xs font-medium"><BilingualText value={bi('Membership', 'العضوية')} /></span>
              </Link>
              ...
              >
                ...
                <span className="text-xs font-medium"><BilingualText value={bi('Payments', 'الدفعات')} /></span>
              </Link>
              ...
              >
                ...
                <span className="text-xs font-medium"><BilingualText value={bi('Documents', 'المستندات')} /></span>
              </Link>
              ...
              >
                ...
                <span className="text-xs font-medium"><BilingualText value={bi('Alerts', 'الإشعارات')} /></span>
              </Link>
              ...
              >
                ...
                <span className="text-xs font-medium"><BilingualText value={bi('Profile', 'الملف الشخصي')} /></span>
              </Link>
              ...
              >
                ...
                <span className="text-xs font-medium"><BilingualText value={bi('Settings', 'الإعدادات')} /></span>
              </Link>
              ...
              >
                <LogOut size={18} />
                <span className="text-xs font-medium"><BilingualText value={bi('Sign Out', 'تسجيل الخروج')} /></span>
              </button>
            </div>
          </div>
        </>
            ...
            <div className="flex items-center justify-between pb-4 border-b border-white/10">
              <div>
                <h3 className="text-lg font-bold text-slate-100 flex items-center gap-2">
                  ...
                  <BilingualText value={bi('Select Sport & Demo Athlete', 'اختر الرياضة واللاعب التجريبي')} />
                </h3>
                <p className="text-xs text-slate-400 mt-0.5">
                  <BilingualText value={bi('Switch between sports to experience truthful sport-specific metrics and schedules.', 'بدّل بين الرياضات لاستعراض المقاييس والجداول الخاصة بكل رياضة.')} />
                </p>
              </div>
              <button
        ...
        <div className="athlete-modal-overlay" onClick={() => setLogoutModalOpen(false)}>
          <div className="athlete-modal-content !max-w-md text-center p-6" onClick={(e) => e.stopPropagation()}>
            ...
            <h3 className="text-lg font-bold text-slate-100">
              <BilingualText value={bi('Sign Out of Athlete Portal?', 'تسجيل الخروج من بوابة اللاعب؟')} />
            </h3>
            <p className="text-xs text-slate-400 mt-2">
              <BilingualText value={bi('You will return to the athlete login screen. You can re-enter preview mode anytime.', 'ستعود إلى شاشة تسجيل دخول اللاعب. يمكنك العودة لوضع المعاينة في أي وقت.')} />
            </p>
