...
export function UiButton({
  ...
  children,
  ...props
}: ButtonHTMLAttributes<HTMLButtonElement> & { variant?: UiButtonVariant }) {
  return (
...
// Use SafeBrandLogo in places where brand markup is needed from primitives
export { default as SafeBrandLogo } from "./SafeBrandLogo";
